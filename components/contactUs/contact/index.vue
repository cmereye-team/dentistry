...
<div>
  <div class=" vedio_box md:font-black">
    ...
    <el-select v-model="ruleForm.region" placeholder="請選擇你的答案">
     ...
     <div class="radioInfo">
      <div class="radiocon"><el-radio v-model="radio" label="1">閣下必須提前至少三個工作天進行網上預約；網上提交表格並不等於預約成功，閣下將會在兩個工作天內以電話或電郵收取預約確認通知；<br>閣下所提供的個人信息只會用於預約服務，所有內容皆會保密處理。</el-radio></div>
