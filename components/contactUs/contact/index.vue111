      ...
      <div class="form">
        <el-form :inline="true" label-position="top" :model="ruleForm"  ref="ruleForm" label-width="100px"
          ...
          <div style="display: none;"> <input type="hidden" name="_wpcf7" value="128"> <input type="hidden"
              ...
              name="_wpcf7_container_post" value="130">
            <input type="hidden" name="_wpcf7_posted_data_hash" value="">
          </div>
          <el-form-item label="姓名"  prop="name" >
            <span class="wpcf7-form-control-wrap" data-name="your-name">
              <el-input  v-model="ruleForm.name" type="text" placeholder="請輸入你的答案" name="your-name" value="" size="40"
        ...
        <div>
          ...
          <span class="wpcf7-form-control-wrap" data-name="your-email">
            <el-form-item label="電郵地址" prop="address">
              <el-input  v-model="ruleForm.address" type="email" name="your-email" value=""  placeholder="請輸入你的答案"
          ...
          <span  class="wpcf7-form-control-wrap" data-name="menu-809">
            ...
            <el-select name="menu-809[]"  v-model="ruleForm.region"
              class="wpcf7-form-control wpcf7-select" id="Options" aria-invalid="false" placeholder="請輸入你的答案" >
          ...
          <div class="radioInfo">
            <div class="radiocon">
              <el-radio v-model="radio" @click.native.prevent="clickitem(1)" :label="1">
                閣下必須提前至少三個工作天進行網上預約；網上提交表格並不等於預約成功，<br>閣下將會在兩個工作天內以電話或電郵收取預約確認通知；閣下所提供的個人信息只會用於預約服務，所有內容皆會保密處理。
              </el-radio>
            </div>
            <div class="radiocon">
              <el-radio v-model="radio1" @click.native.prevent="clickitem(2)" :label="2">
                本人已閱讀，明白及同意收集個人資料及<nuxt-link to="/policy#A1"><span>私隱政策</span></nuxt-link>。</el-radio>
            </div>
            <div class="radiocon">
              <el-radio v-model="radio2" @click.native.prevent="clickitem(3)" :label="3">
