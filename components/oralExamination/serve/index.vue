<template>
  <div>
        ...
        <div class="service_box service_boxs">
          <div class=" service_item" data-wow-delay="0.3s">
            <div class="service_hover"  style="background: #C2C7CD;">
              <nuxt-link to="/oralExamination" style="pointer-events:none;cursor:default;">
    ...
    <div class="mbshow">
      <el-button @click="dialogTableVisible = true">其他牙科服務</el-button>
...
@media only screen and (min-width: 100px) and (max-width: 991px) {
  ::v-deep .el-dialog{
    ...
    background: #FFF;
    border-radius: 46px;
    box-shadow: 0 1px 3px rgba(87, 178, 243, 0.8);
