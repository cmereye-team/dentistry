          ...
          <el-collapse-item name="2">
            ...
            <div class="discon">
              <span>
                <ul>
                  <li>
                    如牙眼齦到不適，應及早幣詢牙醫的建議。若被判斷牙眼發炎是由牙菌斑和牙結石引起的，可透過洗牙清除口腔堆積物，以緩解發炎症狀。
                  </li>
                </ul>
              </span>
            </div>
          ...
          <el-collapse-item name="6">
            ...
            <div class="discon">
              <span>
                <ul>
                  <li>
                    洗牙後出現牙齒敏感或牙縫變大，主要由於牙菌膜和牙結石被清除後，牙根皙時暴簬，增加對冷熱刺激的敏感度。同時，受感染的牙肉會逐漸消腫，使牙縫變得明顯。牙齒敏感情況一般在洗牙後數天內緩解，期間應避免進食冷熱刺激食物。若敏感症狀持續，建議尋求牙醫的協助。
                  </li>
                </ul>
              </span>
            </div>
