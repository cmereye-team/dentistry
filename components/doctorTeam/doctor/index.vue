   ...
   <div class="bg-white comContent py-xs-2">
    ...
    <div class="doctor">
      ...
      <div class="conts">
        <ul>
          <li>香港大學牙醫學士</li>
          <li>愛丁堡皇家外科醫學院口腔外科學院員</li>
          <li>香港大學牙醫碩士</li>
          <li>澳紐皇家牙科醫學院院士</li>
          <li>香港大學口腔頜面外科高級文憑</li>
           <li>香港牙科醫學院院士(口腔頜面外科)專科</li>
          <li>香港醫學專科學院院士(牙科)</li>
          <li>英國皇家外科醫學院植齒學文憑</li>
          <li>香港大學牙醫碩士(植齒學)</li>
          <li>倫敦英皇學院臨床牙科碩士(固定及活動修復齒科)</li>
        </ul>
      </div>
    </div>
    </div>
    <div class="team">
      ...
      <div class="conts">
        <ul>
          ...
          <li>愛丁堡皇家外科醫學院口腔頜面外科學院員</li>
          <li>格拉斯哥皇家醫學院牙科學系院員</li>
          <li>愛丁堡皇家外科醫學院牙科學系院員</li>
          <li>香港牙科醫學院院士(口腔頜面外科)專科</li>
          <li>香港醫學專科學院院士(牙科)</li>
        </ul>
      </div>
    ...
    <div class="team">
     ...
     <div class="doctor">
      ...
      <div class="conts">
        <ul>
          <li>BDS DR MGR Medical Uni (Chennai)</li>
          <li>香港大學牙醫碩士(牙髓病學) </li>
          <li>格拉斯哥皇家醫學院牙科學系院員</li>
        </ul>
      </div>
    ...
    <div class="doctor">
      <div class="name">
        <img src="https://static.cmereye.com/static/lkximg/image/doctorTeam/star.svg" alt="">
        <p><span>沈峰豪</span> 醫生</p>
      </div>
      <div class="conts">
        <ul>
          <li>香港大學牙醫學士</li>
          <li>澳紐皇家牙科醫學院院士(牙科全科)</li>
          <li>香港大學牙醫碩士(矯齒學與牙頜面矯形學)</li>
        </ul>
      </div>
    </div>
    </div>
    <div class="team">
     ...
     <div class="doctor">
      <div class="name">
        <img src="https://static.cmereye.com/static/lkximg/image/doctorTeam/star.svg" alt="">
        <p><span>邱易光</span> 醫生</p>
      </div>
      <div class="conts">
        <ul>
          <li>香港大學牙醫學士</li>
          <li>英國皇家外科醫學院牙醫全科文憑</li>
        </ul>
      </div>
    </div>
    <div class="doctor">
