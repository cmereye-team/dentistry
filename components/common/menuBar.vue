  ...
  <div class="nav-fa">
      ...
      <div class="pcshow header scroll-active">
        <div class="header-logo">
          <nuxt-link class="navbar-brand" to="/">
            ...
            <!-- <img
              src="https://static.cmereye.com/static/loffee/logo/bulelogo.svg"
              alt=""
            />
            <img
              src="https://static.cmereye.com/static/loffee/logo/whitelogo.svg"
              alt=""
            /> -->
          </nuxt-link>
        </div>
        <nav class="header-nav navbar-light navbar navbar-expand-lg">
          <div
            class="gnavd collapse navbar-collapse container-fluid"
          ...
          >
            <ul class="flex">
              ...
              <li class="nav-item">
                <nuxt-link class="nav-link about-us" to="/about-us"
                  >關於我們</nuxt-link
                >
              </li>
              <!-- <li class="nav-item">
                          ...
                          <div class="service_hover implant">
                            <nuxt-link to="/implant" class="implant">
                              <div class="service_pic">
                                <img
                                  src="https://static.cmereye.com/static/lkximg/image/about-me/serve/Frame.png"
                                  title="植牙"
                                  alt="植牙"
                                />
                              </div>
                    ...
                    <li class="nav-item nav-items">
                      <div class="service_box">
                        <div class="service_item">
                          <div class="service_hover">
                            <nuxt-link
                              to="/extractions-and-wisdom-teeth-extraction"
                              class="extractions-and-wisdom-teeth-extraction"
                            >
                              <div class="service_pic">
                                <img
                                  class="imgba teshu"
                        ...
                        <div class="service_item">
                          <div class="service_hover">
                            <nuxt-link
                              ...
                              class="complete-and-partial-denture"
                            >
                              <div class="service_pic">
                                <img
                                  class="allya"
                    ...
                    <li class="nav-item nav-items">
                      <div class="service_box">
                        <div class="service_item">
                          <div class="service_hover">
                            <nuxt-link
                              to="/scaling-and-polishing"
                              class="scaling-and-polishing"
                            >
                              <div class="service_pic">
                                <img
                                  class="teshu"
                    ...
                    <li class="nav-item nav-items">
                      <div class="service_box">
                        <div class="service_item">
                          <div class="service_hover">
                            <nuxt-link
                              to="/general-oral-examination"
                              class="general-oral-examination"
                            >
                              <div class="service_pic">
                                <img
              ...
              <li class="nav-item ipad-not-show">
                <a
                  ...
                  href="tel:85236202428"
                  aria-hidden="true"
                  target="_blank"
                  style="line-height: 20px"
                  >立即預約
                  <span style="font-size: 20px; font-family: Noto Sans HK"
                    >3620 2428</span
                  ></a
                >
              </li>
    ...
    <div
      class="nar sticky-sm-top sticky-top home-content mbshow"
      style="width=90%"
    >
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse pcshow" id="navbarNavDropdown">
           ...
           牙科服務
              ...
              <li class="nav-item">
                <nuxt-link class="nav-link facilities" to="/facilities"
                  >儀器及設備</nuxt-link
                >
                <!-- <a class="nav-link" href="/facilities">儀器及設備</a> -->
              </li>
              <li class="nav-item">
                <nuxt-link
                  class="nav-link oral-health-information"
                  to="/oral-health-information"
                  >健康資訊</nuxt-link
                >
              ...
              <li class="nav-item">
                <nuxt-link class="nav-link contact-us" to="/contact-us"
                  >聯絡我們</nuxt-link
                >
                <!-- <a class="nav-link" href="/contactUs">聯絡我們</a> -->
              </li>
          ...
          <div class="gnav" :class="action === 1 ? 'action' : ''">
           ...
           牙科服務
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <nuxt-link class="dropdown-item" to="/implant"
                        >植牙</nuxt-link
                      >
                    </li>
                    <li>
                      <nuxt-link class="dropdown-item" to="/rct"
                        >根管治療（杜牙根）</nuxt-link
                      >
                    </li>
                    <li>
                      <nuxt-link class="dropdown-item" to="/invisalign"
                        >Invisalign 隱適美</nuxt-link
                      >
                    </li>
                    <li>
                      <nuxt-link class="dropdown-item" to="/veneers"
                        >瓷貼片</nuxt-link
                      >
                    </li>
                    <li>
                      <nuxt-link class="dropdown-item" to="/teeth-whitening"
                        >牙齒美白</nuxt-link
                      >
                    </li>
                    <li>
                      <nuxt-link class="dropdown-item" to="/crowns-and-bridges"
                        >全瓷牙冠及全鋯牙冠</nuxt-link
                      >
                    </li>
                    <li>
                    ...
                    <li>
                      <nuxt-link class="dropdown-item" to="/orthodontics"
                        >矯齒</nuxt-link
                      >
                    </li>
                    <li>
                    ...
                    <li>
                      <nuxt-link class="dropdown-item" to="/fillings"
                        >補牙</nuxt-link
                      >
                    </li>
                    <li>
                    ...
                    <li>
                      <nuxt-link class="dropdown-item" to="/children-dentistry"
                        >兒童牙科保健及治療</nuxt-link
                      >
                    </li>
                  </ul>
...
@media only screen and (max-width: 760px) {
  ...
  *:after {
  ...
  .navbar-light .navbar-toggler-icon {
    background: url("https://static.cmereye.com/static/lkximg/image/banner/BurgerBtn.png")
      no-repeat !important;
  }
