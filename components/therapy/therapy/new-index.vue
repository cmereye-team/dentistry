<template>
  <div class="new-therapy">
    <div class="crumbs main-container">
      <nuxt-link to="/">主頁</nuxt-link><nuxt-link to="/service">牙科服務</nuxt-link><a>根管治療(杜牙根)</a>
    </div>
    <div class="radices_dentis main-container">
      <div>杜牙根</div>
      <div>又稱根管治療，為治療嚴重蛀牙或牙根受細菌感染的手術<br class="pcShow" />方案。當蛀牙菌深入牙髓，引發感染並導致神經發炎，便需<br class="pcShow" />進行杜牙根徹底清除牙髓腔內的細菌與受感染的組織，<br class="pcShow" />以防止感染擴散。</div>
    </div>
